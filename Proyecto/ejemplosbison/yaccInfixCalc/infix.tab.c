...
#line 26 "infix.y"
            { printf ("\t%.10g\n", yyvsp[-1]); }
#line 1092 "infix.tab.c"
    break;

  case 7: /* exp: exp '+' exp  */
#line 30 "infix.y"
                     { yyval = yyvsp[-2] + yyvsp[0];      }
#line 1098 "infix.tab.c"
    break;

  case 8: /* exp: exp '-' exp  */
#line 31 "infix.y"
                     { yyval = yyvsp[-2] - yyvsp[0];      }
#line 1104 "infix.tab.c"
    break;

  case 9: /* exp: exp '*' exp  */
#line 32 "infix.y"
                     { yyval = yyvsp[-2] * yyvsp[0];      }
#line 1110 "infix.tab.c"
    break;
