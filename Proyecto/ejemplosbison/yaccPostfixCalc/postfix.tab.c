...
static const char *const yytname[] =
{
  ...
  "'+'", "'*'", "$accept", "entrada", "linea", "expresion", YY_NULLPTR
};
...
#line 21 "postfix.y"
                                    { printf("\n Resultado = %d \n ", yyvsp[-1]); }
#line 1078 "postfix.tab.c"
    break;

  case 6: /* expresion: expresion expresion '+'  */
#line 24 "postfix.y"
                                    { yyval = yyvsp[-2] + yyvsp[-1]; }
#line 1084 "postfix.tab.c"
    break;

  case 7: /* expresion: expresion expresion '*'  */
#line 25 "postfix.y"
                                    { yyval = yyvsp[-2] * yyvsp[-1]; }
#line 1090 "postfix.tab.c"
    break;

  case 8: /* expresion: NUMERO  */
#line 26 "postfix.y"
                                    { yyval = yyvsp[0]; }
#line 1096 "postfix.tab.c"
    break;
